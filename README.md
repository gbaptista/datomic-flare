...
{
  "data": {
    "db-before": "datomic.db.Db@136366b4",
    "db-after": "datomic.db.Db@5a29496e",
    "tx-data": [
      [13194139534315, 50, "2024-09-29T11:41:58.128Z", 13194139534315, true],
    ...
    "tempids": {
      "-9223300668110431309": 72,
      "-9223300668110431308": 73,
      "-9223300668110431307": 74
    }
  }
}
```
...
{
  "data": {
    "db-before": "datomic.db.Db@1f2bdc4f",
    "db-after": "datomic.db.Db@17a34aa7",
    "tx-data": [
      [13194139534316, 50, "2024-09-29T11:41:58.144Z", 13194139534316, true],
...
{
  "data": {
    "db-before": "datomic.db.Db@4633dc66",
    "db-after": "datomic.db.Db@45f81af4",
    "tx-data": [
      [13194139534318, 50, "2024-09-29T11:41:58.161Z", 13194139534318, true],
...
{
  "data": {
    "db-before": "datomic.db.Db@2efe07a2",
    "db-after": "datomic.db.Db@3e0c592a",
    "tx-data": [
      [13194139534322, 50, "2024-09-29T11:41:58.225Z", 13194139534322, true],
...
{
  "data": {
    "db-before": "datomic.db.Db@7f042300",
    "db-after": "datomic.db.Db@270c106a",
    "tx-data": [
      [13194139534323, 50, "2024-09-29T11:41:58.238Z", 13194139534323, true],
...
{
  "data": {
    "db-before": "datomic.db.Db@7911d03e",
    "db-after": "datomic.db.Db@2508133f",
    "tx-data": [
      [13194139534324, 50, "2024-09-29T11:41:58.251Z", 13194139534324, true]
    ],
    "tempids": {
    }
  }
...
{
  "data": {
    "db-before": "datomic.db.Db@7b4a38bd",
    "db-after": "datomic.db.Db@3c02e8fe",
    "tx-data": [
      [13194139534325, 50, "2024-09-29T11:41:58.264Z", 13194139534325, true],
